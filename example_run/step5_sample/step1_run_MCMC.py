...
stretchfactor = 1.1                                                             # why is it not 2?
...
bw= np.load('../step4_powell/output/optimized_walkers.npy')
n_opts= bw.shape[0]
bw_lnprob= -np.load('../step4_powell/output/optimized_walkers_lnprob.npy')
