...
def converter(q, ATPfrac, Temp):
    ...
    dk_d_ATU, dk_d_ADT, dk_d_ADS, dk_d_ASU = 10**q[:28]
    
    # sparsity hypothesis: nucleotide-bound state affects binding affinity
    dk_a_UDP= dk_a_SDP= dk_a_TDP= dk_a_DDP= dk_a_DP
    dk_b_UDP= dk_b_SDP= dk_b_TDP= dk_b_DDP= dk_b_DP
    dk_a_TTP= dk_a_STP= dk_a_DTP= 1.0
    dk_b_STP= dk_b_DTP= dk_b_TTP= 1.0
...
# note that there is no experimental input to the KaiA on/off rates
